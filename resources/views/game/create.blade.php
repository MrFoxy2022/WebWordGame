    ...
    <div class="container">
        <form style="font-size: 25px; width: 40%; margin: 80px auto;" class="row-word" action="{{ route('game.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input name="game_name" type="text" minlength="2" maxlength="20" value="{{ old('name') ? old('name') : 'Game' }}" class="form-control" id="game_name" style="font-size: 20px;">
                @error('game_name')
            ...
            <div class="mb-3">
                ...
                <input name="attempts" type="number" max="10" min="0" value="{{ old('attempts') ? old('attempts') : '5' }}" class="form-control" id="attempts" style="font-size: 20px;">
                @error('attempts')
                    <p class="text-danger" style="font-size: 15px;">{{ $message }}</p>
                @enderror
            </div>
